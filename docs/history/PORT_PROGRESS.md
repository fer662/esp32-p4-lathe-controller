...
The tablet accepted and verified the 0.3.26 application upload,
...
The tablet accepted and verified the 0.3.25 application upload,
then initiated restart. Its HTTP service responds, but diagnostics returns 403
until the operator opens Diagnostics locally; running-version/boot acceptance
...
On 2026-09-16 the tablet accepted and verified the application
