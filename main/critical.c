...
void IRAM_ATTR lathe_critical_enter(portMUX_TYPE *lock, unsigned tag)
{
...
void IRAM_ATTR lathe_critical_exit(portMUX_TYPE *lock)
{
    unsigned core = xPortGetCoreID();
...
void IRAM_ATTR lathe_critical_reset(void)
{
