...
Read from committed lathe controller `981851b` (`main/modes/ModeTurn.cpp`), without using its
...
`python3 tests/thread_native_test.py` compiles the production batch
