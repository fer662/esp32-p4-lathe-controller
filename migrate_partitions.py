#!/usr/bin/env python3
"""One-time USB migration, preserving original controller data and a full restore backup."""
...
app=a.build/'esp32-p4-lathe-controller.bin';boot=a.build/'bootloader/bootloader.bin';table=a.build/'partition_table/partition-table.bin';ota=a.build/'ota_data_initial.bin'
