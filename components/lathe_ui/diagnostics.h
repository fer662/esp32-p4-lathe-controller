...
void lathe_diagnostics_start(void); // Local UI/USB only; expires after 30 minutes.
void lathe_diagnostics_stop(void);
bool lathe_diagnostics_active(void);
void lathe_diagnostics_snapshot(lathe_diagnostics_t *snapshot);
#ifdef __cplusplus
}
#endif
