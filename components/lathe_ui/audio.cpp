...
extern "C" void lathe_audio_start(void)
{
    ...
    if (!commands || xTaskCreatePinnedToCore(audio_task, "LATHE_audio", 4096, nullptr, 1, nullptr, 0) != pdPASS)
        initialized = true;
}
...
extern "C" bool lathe_audio_ready(void)
{
    return available.load();
}

extern "C" bool lathe_audio_initialized(void) { return initialized.load(); }
