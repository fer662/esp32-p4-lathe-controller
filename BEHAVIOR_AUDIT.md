...
- Old committed lathe controller firmware: `981851b` in `projects/lathe controller`. Uncommitted motion-planner experiments excluded.
...
This is a source comparison, not a loaded-machine test or proof of complete behavioral equivalence. No firmware changes or machine commands were made for this audit. Paths below are relative to this controller directory unless prefixed with `lathe controller:`; those references mean the committed old source above.
...
Sources: `components/lathe_ui/ui.cpp::preview_cycle`, `components/lathe_ui/cycle_plan.c::lathe_cycle_plan`, `main/cycle.c::poll_cycle`; lathe controller: `main/NormalOperationMode.cpp::update`, `main/modes/ModeTurn.cpp::modeTurn`, `main/main.cpp::modeCut/modeEllipse`.
...
Sources: `components/lathe_ui/cycle_plan.c::lathe_cycle_plan`, `main/cycle.c::emit`; lathe controller: `main/NormalOperationMode.cpp::update`, `main/modes/ModeTurn.cpp::modeTurn`.
...
Sources: `components/lathe_ui/ui.cpp::buttonOnOffPress`, `main/follow.c`; lathe controller: `main/modes/GearBoxMode.cpp`, `main/main.cpp::posFromSpindle/modeCone`.
...
Sources: `components/lathe_ui/cycle_plan.c::lathe_cycle_plan/lathe_cycle_point`, `main/cycle.c::emit` stages 1/8, 2/9 and 11/12; lathe controller: `main/main.cpp::modeEllipse`.
...
Sources: `components/lathe_ui/ui.cpp::apply_feed_edit/setTurnPasses/setStarts/setLeftStop/setRightStop`, `main/cycle.c::poll_cycle`, `main/follow.c`; lathe controller: `main/main.cpp::applyDupr/applyStarts/setTurnPasses/buttonOnOffPress`, `main/modes/ModeTurn.cpp::modeTurn`.
...
Sources: `components/lathe_ui/ui.cpp::lathe_ui_jog`, `main/follow.c` manual-jog branch, `main/cycle.c::emit`; lathe controller: `main/main.cpp::getStepMaxSpeed/taskMoveX`, `main/modes/ModeTurn.cpp::modeTurn`.

### 7. Power-cycle restoration is different

Old lathe controller stored and restored axis positions, display origins, machining stops and each axis's disabled selection. The port does not restore machine positions, machining stops or disabled selections. Neither firmware restores an armed operation.
...
Sources: `components/lathe_ui/preferences.h`, `components/lathe_ui/ui.cpp` axis initialization, `main/driver.c` disabled-state initialization and work-zero command, `main/storage.c::read_core/write_core`; lathe controller: `main/main.cpp::saveIfChanged/setup`.
